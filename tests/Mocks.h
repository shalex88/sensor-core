...
public:
    ...
    MOCK_METHOD(Result<std::string>, getStreamUrl, (uint32_t), (const, override));
    ...
    MOCK_METHOD(Result<common::types::zoom>, setZoomAndGet, (uint32_t, common::types::zoom), (const, override));
    MOCK_METHOD(Result<common::types::zoom>, goToMinZoomAndGet, (uint32_t), (const, override));
    MOCK_METHOD(Result<common::types::zoom>, goToMaxZoomAndGet, (uint32_t), (const, override));
    MOCK_METHOD(Result<common::types::focus>, setFocusAndGet, (uint32_t, common::types::focus), (const, override));
    MOCK_METHOD(Result<bool>, enableAutoFocusAndGet, (uint32_t, bool), (const, override));
    MOCK_METHOD(Result<bool>, stabilizeAndGet, (uint32_t, bool), (const, override));
    ...
    MOCK_METHOD(Result<bool>, SetVideoCapabilityStateAndGet, (uint32_t, const std::string&, bool), (const, override));
